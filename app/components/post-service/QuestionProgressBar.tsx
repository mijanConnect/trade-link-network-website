export default function QuestionProgressBar() {
  return (
    <>
      <div className="mb-8">
        <h2 className="text-[20px] font-semibold text-primaryTextLight mb-2">
        ...
        <div className="mb-6">
          <span className="text-[16px] font-medium text-primaryTextLight">
            06/10
          </span>
        </div>
        <h3 className="text-[40px] font-bold text-primary leading-12">
